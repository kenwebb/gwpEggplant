export function getLocalizedStrings( locale, collection ) {
  ...
  const en_CA = {
    ...
    //speciesname: 'SpName01,SpName02,SpName03'.split(','),
    speciesname:
...
Malva neglecta,Medeola virginiana,Medicago sativa,Melilotus albus,Mentha arvensis,Micranthes virginiensis,Mimulus ringens,Mitella diphylla,
...
Potentilla argentea,Potentilla norvegica,Potentilla recta,Potentilla simplex,Prunella vulgaris,Pyrola elliptica,Ranunculus abortivus,Ranunculus acris,
...
Symphyotrichum lanceolatum,Symphyotrichum lateriflorum,Symphyotrichum novae-angliae Andrea made me do this HAH,Symphyotrichum puniceum,Synapis arvensis,Tanacetum vulgare,Taraxacum officinale,Teucrium canadense,
...
Hoary alyssum,Hobblebush,Hooked agrimony,Indian cucumber-root,Indian pipe,Indian tobacco,Jack-in-the-pulpit,Kidney-leaved buttercup,
...
Typhaceae,Urticaceae,Verbenaceae,Violaceae`.split(',').map(item => item.trim()),
    ...
    queryfiltername: 'Flower colour,Leaf type,Leaf arrangement,Flowering in,Species name,Common name,Family name,Trail number'.split(","),
    querydone: "DONE",
    yes: "yes",
    no: "no",
    flowerdetailslabels: 'Common name,Family,Native,Flower colour,Leaf type,Leaf arrangement,Flowering range,# of photos'.split(',')
  }
...
Lysimaque ciliée,Lysimaque terrestre,Lysimaque thyrsiflore,Marguerite blanche,Mauve musquée,Mauve négligée,Maïanthème du Canada,Menthe des champs,
...
Quenouille à feuilles larges,Quenouille à feuilles étroites,Renoncule abortive,Renoncule rampante,Renoncule âcre,Renouée de Pennsylvanie,Renouée sagittée,Renouée à noeuds ciliés,
...
Typhacées,Urticacées,Verbénacées,Violacées`.split(',').map(item => item.trim()),
    ...
    queryfiltername: "Couleur de la fleur,Type de feuille,Disposition des feuilles,Floraison,Nom de l'espèce,Nom commun,Nom de famille,Numéro du sentier".split(","),
    querydone: "FINI",
    yes: "oui",
    no: "non",
    flowerdetailslabels: 'Nom commun,Famille,Native,Couleur de la fleur,Type de feuille,Disposition des feuilles,Floraison range,# de photos'.split(',')
  }
